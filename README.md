...
Para mantener el historial limpio, utilizamos mensajes en presente y descriptivos:

* feat: Para nuevas funcionalidades (ej. feat: agregar movimiento del jugador).
* fix: Para corrección de errores (ej. fix: corregir anclaje del boton salir).
* docs: Para actualizaciones de documentación (ej. docs: actualizar integrantes en README).